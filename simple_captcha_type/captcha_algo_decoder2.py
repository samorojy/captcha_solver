...
def detekt_letter(image):
    alphabet_list_with_weight = [('A', 230, 26), ('B', 270, 22), ('C', 190, 26), ('D', 282, 28),
                                 ('E', 208, 21),('F', 166, 20), ('G', 224, 27), ('H', 260, 28),
                                 ('I', 112, 11), ('J', 131, 12), ('K', 228, 25), ('L', 148, 20),
                                 ('M', 368, 33),  ('N', 268, 28), ('O', 265, 30), ('P', 211, 21),
                                 ('Q', 297, 30), ('R', 263, 24), ('S', 185, 20), ('T', 172, 24),
                                 ('U', 217, 26),   ('V', 197, 25), ('W', 354, 33), ('X', 216, 24),
                                 ('Y', 165, 24), ('Z', 211, 23)]
